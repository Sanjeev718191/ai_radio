...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    setupAlan();
    fetchRadios();//fetch audion to play
  ...
  setupAlan() {
    AlanVoice.addButton("10db83830e0c9b816c52bf92b7c9c1c52e956eca572e1d8b807a3e2338fdd0dc/stage",
          ...
          [
            AppBar(
              title: "AI Radio".text.xl4.bold.white.make().shimmer(
                  primaryColor: Color.fromARGB(255, 211, 101, 255), secondaryColor: Colors.white),
